...
def sum_checker(
    ...
    input_result_tushit, input_result_russ, input_result_pinshun, input_result_rake
):
    return_sum = (
        input_result_ben + input_result_liang + input_result_loon +
        input_result_seb + input_result_shuming +input_result_yopo +
    ...
    list_results = [
        ...
        input_result_francis, input_result_tushit, input_result_pinshun, input_result_rake
    ]
